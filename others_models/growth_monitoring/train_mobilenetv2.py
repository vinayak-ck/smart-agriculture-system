...
# ---------------------------------------------------------
# Train MobileNetV2 for Rice Leaf Disease Detection
# ---------------------------------------------------------
...
def train(data_dir, epochs=5, batch_size=16, lr=1e-4):
    ...
    torch.save(
        model.state_dict(),
        MODEL_DIR / 'mobilenetv2_final.pth'
    )

    print("\n✅ Training Complete!")
    print(f"   Model Saved : {MODEL_DIR/'mobilenetv2_final.pth'}")
